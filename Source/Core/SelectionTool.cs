...
namespace Dataweb.NShape
{
	...
	public class SelectionTool : Tool
	{
		...
		//		+ Environment.NewLine
		//		+ "Selected objects can be moved by dragging them to the target position or resized by dragging a control point to the target position";

			Title = "Указатель";
			ToolTipText = "Выберите один или несколько объектов, удерживая клавишу shift, щелчком или обводя рамкой."
				+ Environment.NewLine
				+ "Выбранные объекты можно перемещать, перетаскивая их в целевое положение, или изменять их размер, перетаскивая контрольную точку в целевое положение";
