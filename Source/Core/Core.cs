...
namespace Dataweb.NShape.Advanced
{
	...
	/// in a System.Windows.Forms.PropertyGrid control set to Categorized mode.
	/// </summary>
	public class CategoryMap : CategoryAttribute
	{
		...
		protected override string GetLocalizedString(string value)
		{
			return Properties.Resources.Text_CategoryMap;
		}


		private const string categoryName = "Map";
	...
	public interface IDisplayService
	{
		...
		/// Карта-подложка
		/// </summary>
		GMap.NET.MapProviders.GMapProvider MapProvider { get; set; }

		/// <summary>Количество статических свойств</summary>
		int StaticPropsCount { get; set; }

		/// <summary>Количество динамических свойств</summary>
		int DynamicPropsCount { get; set; }
	}
