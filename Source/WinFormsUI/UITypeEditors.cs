...
namespace Dataweb.NShape.WinFormsUI
{
	...
	/// <summary></summary>
	public class MapProviderConverter : TypeConverter
	{
		static private List<GMap.NET.MapProviders.GMapProvider> gMapProviders = new List<GMap.NET.MapProviders.GMapProvider>
		(new GMap.NET.MapProviders.GMapProvider[]
			{   GMap.NET.MapProviders.EmptyProvider.Instance
			,   GMap.NET.MapProviders.GMapProviders.OpenStreetMap
			,   GMap.NET.MapProviders.GMapProviders.YandexMap
		//	,	GMap.NET.MapProviders.GMapProviders.YandexSatelliteMap
		//	,	GMap.NET.MapProviders.GMapProviders.YandexHybridMap
		...
		/// <summary>Ѕудем предоставл€ть выбор из списка</summary>
		public override bool GetStandardValuesSupported(ITypeDescriptorContext context)
		{
			return true;
		}

		/// <summary>... и только из списка</summary>
		public override bool GetStandardValuesExclusive(ITypeDescriptorContext context)
		{
			// false - можно вводить вручную, true - только выбор из списка
			return true;
		}

		/// <summary>ј вот и список</summary>
		public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
		{
			// возвращаем список строк из настроек программы (базы данных, интернет и т.д.)
			return new StandardValuesCollection(gMapProviders);
		}
		...
		public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
		{
			if (value is string)
			{
				...
				foreach (var gMapProvider in gMapProviders)
					if (gMapProvider.Name == s)
						return gMapProvider;
			}
		...
		public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
		{
			if (value is GMap.NET.MapProviders.GMapProvider
			&& destinationType == typeof(string))
				return ((GMap.NET.MapProviders.GMapProvider)value).Name;
			return base.ConvertTo(context, culture, value, destinationType);
		}
	}
	#endregion
