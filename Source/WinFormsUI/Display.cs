...
namespace Dataweb.NShape.WinFormsUI
{
	...
	public partial class Display : GMapControl/*UserControl*/, IDiagramPresenter, IDisplayService
	{
		...
		//?	// Указываем что все края элемента управления закрепляются у краев содержащего его элемента управления(главной формы), а их размеры изменяются соответствующим образом
		...
		//	GMap.NET.MapProviders.GMapProvider.Language = GMap.NET.LanguageType.English;
			...
			// Если вы используете интернет через прокси сервер, указываем свои учетные данные.
...
//?
//?			List<GMap.NET.PointLatLng> points = new List<GMap.NET.PointLatLng>(); //Лист с точками
